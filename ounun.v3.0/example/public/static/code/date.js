...
Calendar.prototype.draw = function()
{
    ...
    mvAry[mvAry.length] = '        <th align="center" width="98%" nowrap="nowrap"><select name="calendarYear" id="calendarYear" style="font-size:12px;width: auto;border-radius:0px;padding:0px;margin-bottom:0px;height: auto;"></select><select name="calendarMonth" id="calendarMonth" style="font-size:12px;width: auto;border-radius:0px;padding:0px;margin-bottom:0px;height: auto;"></select></th>';
