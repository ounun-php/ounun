...
<head>
    ...
    <script type="text/javascript">
        ...
        var site_key	= '<?php echo \adm::$auth->cookie_get(adm_purv::cp_site) ?>';
        var zqun_key	= '<?php echo \adm::$auth->cookie_get(adm_purv::cp_zqun) ?>';
        var libs_key	= '<?php echo \adm::$auth->cookie_get(adm_purv::cp_libs) ?>';
