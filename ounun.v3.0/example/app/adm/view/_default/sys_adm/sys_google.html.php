            ...
            <table class="tb tb2 ">
                ...
                <tr>
                    ...
                    <td colspan="15"><div class="fixsel">
                            <input type="submit" class="btn" id="submit" name="submit" title="按 Enter 键可随时提交你的修改" value="关闭Google身份验证" />
                        </div></td>
                </tr>
            </table>
        </form>
        ...
        <form name="cpform" method="post" autocomplete="off"  id="cpform" onsubmit="return check_form();">
            ...
            <table class="tb tb2 ">
                ...
                <tr style="height:20px" class="hover" id="tr_down">
                    ...
                    <td>
                        <br />
                        <a href="https://hd.m.aliyun.com/act/download.html" target="_blank" style="font-size: 16px;">
                ...
                <tr style="height:20px;display:none;" class="hover" id="tr_2">
                    ...
                    <td>
                        <br />
                        <a href="#" onclick="step_2_good();"><span style="font-size: 16px;">扫码</span>(正常人都选这个)</a> <br />
                        <a href="#" onclick="step_2_bad();"><span style="font-size: 16px;">手输</span>(手机摄像头坏了，用手输入)</a><br /><br />
                    </td>
                </tr>
                ...
                <tr style="height:20px;display: none;" class="hover" id="tr_2_bad">
                    ...
                    <td>
                        ...
                        授权码:<input class="txt" type="text" style="width: 300px;" value="<?php echo $cs;?>" readonly="readonly" />
                        <br />
                        <br />
                        <br />
                        <a href="#" onclick="step_3();"> <span style="color: #DD0000;font-size: 18px;">(已前扫码/手输过，请先删除本项)</span>我扫码好，进行下一步</a>
                ...
                <tr style="display: none;" id="tr_3_btn">
                    ...
                    <td colspan="15">
                        <div class="fixsel">
                            <input type="submit" class="btn" id="submit" title="按 Enter 键可随时提交你的修改" value="保存 并 开启Google身份验证" />
                        </div>
                    </td>
                </tr>
            </table>
