...
class db
{
    ...
    public function __construct(array $cfg,string $driver = 'mysql')
    {
        if($cfg['charset'])
        {
    ...
    {
        return "{$this->_driver}:host={$this->_host};port={$this->_post};dbname={$this->_database};charset={$this->_charset}";
    }
    /**
     * 激活当前连接
    ...
    public function active()
    {
        if(null == $this->_conn)
        {
            ...
            $this->_conn = new PDO($dsn,$this->_username,$this->_password,$options);
        }
    }
