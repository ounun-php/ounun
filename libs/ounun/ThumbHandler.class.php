...
class ThumbHandler
{
     ...
     */
    public function setDstImg(string $dst_img)
    {
        $arr  = explode('/',$dst_img);
        $last = array_pop($arr);
        $path = implode('/',$arr);
     ...
     * @param    string      $n    质量
     */
    public function setImgDisplayQuality(int $n)
    {
        $this->img_display_quality = $n;
    }
     ...
     * @param    string      $n    质量
     */
    public function setImgCreateQuality(int $n)
    {
        $this->img_create_quality = $n;
    }
